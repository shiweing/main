...
IMPORTANT: TITLE and CONTENT cannot be both empty.
...
image::ug_notecreate1.png[]

. A note is created with the title "MIPS" and content "https://en.wikipedia.org/wiki/MIPS_architecture". The note is also tagged with the hashtag "cs2100 assignment". +
The note created is displayed in the right pane.
+
.Note created after command execution
image::ug_notecreate2.png[]
...
image::ug_noteedit1.png[]

. The title of the note will be changed from "MIPS" to "Assignment 2: MIPS".
+
.Note edited after command execution
image::ug_noteedit2.png[]
...
image::ug_notelist1.png[]

. All notes are displayed.
+
.All notes displayed
image::ug_notelist2.png[]

. When you would like to find the notes containg the keyword "cs", you can enter the command `note list cs`.
+
.Entering `note list` command with keyword
image::ug_notelist3.png[]

. Notes containing the keyword "cs" are displayed.
+
.Notes containing keyword displayed
image::ug_notelist4.png[]
...
image::ug_notelist7.png[]

. Notes tagged with contact of contact id "1" group with group name "cs2103t" are displayed.
+
.Filtered notes displayed
image::ug_notelist8.png[]
