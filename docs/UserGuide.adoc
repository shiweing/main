...
`note create --T MIPS --c https://en.wikipedia.org/wiki/MIPS_architecture --t #cs2100 assignment`
+
...
. If you find that your note title should have more information, you can enter the command `note edit 16 --T Assigment 2: MIPS`
+
